...
function Kiosks() {
  ...
  async function getkioskdata() {
    await axios
      .post(URL + "/GetKioskList", { role: role, reseller_id: '', customer_id: '-1', }, Header)
      .then((response) => {
        setData(response.data.data);
        //console.log(response)
      })
  ...
  async function openModal(resource) {
    ...
    setm_Scan(valuekioskinfo.scanenabled.toString());
              ...
              <div className="card p-2 px-4">
                <form action="" className="information_form" onSubmit={(e) => e.preventDefault()}>
                  <div className="row mt-3">
                    ...
                    <div className="col-md-2">
                      <div className="input-group">
                        <button className="btn btn-outline-success allBtnsize" onClick={() => { setFirstPage(); searchKiosk(); }} disabled={searchKiosksData === '' ? true : false}>{t('Search')}</button>
                      </div>
                    </div>
                  </div>
                </form>
                                      ...
                                      <Tab eventKey="profile" title={t('Printer')}>
                                        ...
                                        <div className="formProgress manForm pt-2">
                                          ...
                                          <div className="mb-3">
                                            <div className="row">
                                              <div className="col-md-4">
                                                <label className="lablePapding" for="m_topupcomment">{t('SerialNumber')}</label>
                                              </div>
                                              <div className="col-md-8">
                                                  ...
                                                  <div className="col-md-6">
                                                    <div className="form-check">
                                                      <input type="radio" className="form-check-input" id="m_Fax2" name="m_Fax" value="0" checked={m_Fax === '0'}
                                                        onChange={(e) => { setm_Fax(e.target.value) }} />
                                                  ...
                                                  <div className="col-md-6">
                                                    <div className="form-check">
                                                      <input type="radio" className="form-check-input" id="m_Scan1" name="m_Scan" value="1" checked={m_Scan === '1'}
                                                        onChange={(e) => { setm_Scan(e.target.value) }} />
