                        ...
                        <div>
                          <div id="datatable_wrapper" className="information_dataTables dataTables_wrapper dt-bootstrap4 table-responsive">
                            <div className="d-flex exportPopupBtn">
                              ...
                              <CSVLink headers={title} data={data} filename="AdminPrinter.csv">
                            ...
                            <table className="display table-bordered dataTable no-footer mt-6">
                              ...
                              <tbody>
                                {currentItems.length > 0 ? currentItems.map((item, k) => {
                                  return <tr key={k} onClick={() => openModal({ mseq: item.seq, mmodel: item.printermodel })} className="odd show-modal">
                                    ...
                                    <div className="widget box">
                                      <div className="widget-header">
                                        <h4>
                                          ...
                                          <span id="m_modelNserial">({modelName})</span>
                                        </h4>
                                      </div>
