...
function Salesinformationbydate() {
  ...
  async function GetTransactionListByDay() {
    ...
    await axios.post(URL + "/GetTransactionListByDay", { reseller_id: reseller_id, customer_id: customerseq, fromdate: startDates, todate: endDates, location: '' }, Header).then((response) => {
                        ...
                        <div>
                          <div id="datatable_wrapper" className="information_dataTables dataTables_wrapper dt-bootstrap4 table-responsive">
                            <div className="d-flex exportPopupBtn">
                              <CSVLink headers={title} data={data} filename="CustomerByDateList.csv">
