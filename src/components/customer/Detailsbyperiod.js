...
function Detailsbyperiod() {
  ...
  async function GetLocationList() {
    ...
    await axios.post(URL + "/GetLocationList", { customerid: customerseq }, Header).then((response) => {
                        ...
                        <div>
                          <div id="datatable_wrapper" className="information_dataTables dataTables_wrapper dt-bootstrap4 table-responsive">
                            <div className="d-flex exportPopupBtn">
                              <CSVLink headers={title} data={data} filename="CustomerDetalsByCaseList.csv">
                                <button className="btn btn-info">{t('Export')}</button>
                              </CSVLink>
                            </div>
                            <table className="display table-bordered dataTable no-footer mt-6">
                              ...
                              <tbody>
                                ...
                                }) : <tr className="odd"><td valign="top" colSpan="19" className="dataTables_empty">{t('NoDataAvailable')}</td></tr>}
